    ...
    if (isset($_POST['submit'])) {
       ...
       VALUES('" . $first_name . "', '" . $last_name . "', '" . $email . "', md5('$password'))";
        ...
        if (mysqli_query($connect, $sql)) {
            ...
            $mail->Port = '465';
            $mail->isHTML();
            $mail->Username = 'wtxcotton.uashubs@gmail.com';// FROM
            $mail->Password = '080fne8xYuSu';
            $mail->SetFrom('wtxcotton.uashubs@gmail.com');// FROM
            $mail->AddAddress('hamdori@gmail.com');// TO
