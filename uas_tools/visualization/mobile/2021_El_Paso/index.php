...
<input type="hidden" value='<?php echo json_encode($picture_data); ?>' id="picture_data" name="picture_data">
    <script>
        function all() {
            ...
            var map = L.map('map', {
                center: L.latLng([31.527922,-106.195344]),
                zoom: 19,
                minZoom
        :
            17,
        ...
        :
            ...
            // Layers
            var layer_20210602_p4r_el_paso_ortho = L.tileLayer('https://wtxcotton.uashubs.com/uas_data/uploads/products/2021_El_Paso/DJI_Phantom_4_RTK/RGB/06-02-2021/20210602/ortho/20210602_p4r_el_paso_ortho/Display/{z}/{x}/{y}.png', {tms: true, zIndex: 50, bounds: L.latLngBounds([L.latLng(31.5295,-106.19702222222),L.latLng(31.529527777778,-106.19401388889),L.latLng(31.526944444444,-106.19398055556),L.latLng(31.526916666667,-106.19698888889),L.latLng(31.5295,-106.19702222222)])});
	...
	layers: [
		{
			name: '06/02/2021',
active: 'true',
			layer: layer_20210602_p4r_el_paso_ortho
		},
	]
},
