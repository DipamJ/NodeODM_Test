...
<head>
    ...
    <title>2021 Martin County Dry RACE</title>
...
<input type="hidden" value='<?php echo json_encode($picture_data); ?>' id="picture_data" name="picture_data">
    <script>
        function all() {
            ...
            var map = L.map('map', {
                center: L.latLng([32.429176,-101.939200]),
                zoom: 19,
                minZoom
        :
            17,
        ...
        :
            ...
            // Layers
            var layer_20210619_lb_p4r_cotton_martin_ortho = L.tileLayer('https://wtxcotton.uashubs.com/uas_data/uploads/products/2021_Martin_County_Dry_RACE/DJI_Phantom_4_RTK/RGB/06-19-2021/20210619/ortho/20210619_lb_p4r_cotton_martin_ortho/Display/{z}/{x}/{y}.png', {tms: true, zIndex: 50, bounds: L.latLngBounds([L.latLng(32.431411111111,-101.94393888889),L.latLng(32.431641666667,-101.93404166667),L.latLng(32.426883333333,-101.93388611111),L.latLng(32.426652777778,-101.94378333333),L.latLng(32.431411111111,-101.94393888889)])});
	...
	layers: [
		{
			name: '06/19/2021',
active: 'true',
			layer: layer_20210619_lb_p4r_cotton_martin_ortho
		},
	]
},
