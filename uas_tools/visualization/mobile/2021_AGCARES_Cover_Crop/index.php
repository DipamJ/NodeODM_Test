...
<input type="hidden" value='<?php echo json_encode($picture_data); ?>' id="picture_data" name="picture_data">
    <script>
        ...
        :
            ...
            // Layers
            var layer_20210127_lb_p4r_cover_crop_mosaic_shiftf = L.tileLayer('https://wtxcotton2.uashubs.com/uas_data/uploads/products/2021_AGCARES_Cover_Crop/DJI_Phantom_4_RTK/RGB/01-27-2021/20210127/RGB_Ortho/20210127_lb_p4r_cover_crop_mosaic_shift/Display/{z}/{x}/{y}.png', {tms: true, zIndex: 50, bounds: L.latLngBounds([L.latLng(32.776219444444,-101.94776944444),L.latLng(32.776247222222,-101.94661666667),L.latLng(32.773713888889,-101.94653333333),L.latLng(32.773686111111,-101.94768611111),L.latLng(32.776219444444,-101.94776944444)])}); 
var layer_20210226_lb_p4r_cover_crop_mosaic_shiftf = L.tileLayer('https://wtxcotton2.uashubs.com/uas_data/uploads/products/2021_AGCARES_Cover_Crop/DJI_Phantom_4_RTK/RGB/02-26-2021/20210226/RGB_Ortho/20210226_lb_p4r_cover_crop_mosaic_shift/Display/{z}/{x}/{y}.png', {tms: true, zIndex: 51, bounds: L.latLngBounds([L.latLng(32.776219444444,-101.94776944444),L.latLng(32.776247222222,-101.94661666667),L.latLng(32.773713888889,-101.94653333333),L.latLng(32.773686111111,-101.94768611111),L.latLng(32.776219444444,-101.94776944444)])}); 
var layer_20210413_lb_p4r_cover_crop_mosaic_shiftf = L.tileLayer('https://wtxcotton2.uashubs.com/uas_data/uploads/products/2021_AGCARES_Cover_Crop/DJI_Phantom_4_RTK/RGB/04-13-2021/20210413/RGB_Ortho/20210413_lb_p4r_cover_crop_mosaic_shift/Display/{z}/{x}/{y}.png', {tms: true, zIndex: 52, bounds: L.latLngBounds([L.latLng(32.776219444444,-101.94776944444),L.latLng(32.776247222222,-101.94661666667),L.latLng(32.773713888889,-101.94653333333),L.latLng(32.773686111111,-101.94768611111),L.latLng(32.776219444444,-101.94776944444)])}); 
var layer_20210522_lb_p4r_cover_crop_mosaic_shiftf = L.tileLayer('https://wtxcotton2.uashubs.com/uas_data/uploads/products/2021_AGCARES_Cover_Crop/DJI_Phantom_4_RTK/RGB/05-22-2021/20210522/RGB_Ortho/20210522_lb_p4r_cover_crop_mosaic_shift/Display/{z}/{x}/{y}.png', {tms: true, zIndex: 53, bounds: L.latLngBounds([L.latLng(32.776219444444,-101.94777222222),L.latLng(32.776247222222,-101.94661666667),L.latLng(32.773713888889,-101.94653333333),L.latLng(32.773686111111,-101.94768611111),L.latLng(32.776219444444,-101.94777222222)])}); 
