...
// ADDED
// var cc_210630 = new L.GeoJSON.AJAX("gis_layers/2021_cc_driscoll_10m_grid_canopy_cover_cotton.geojson", {onEachFeature:popUp_cc_210630, zIndex: 101, style: function (feature){// THIRD
// return {
//   "color": 'black',
//   "weight": 1,
//   "opacity": 1,
//   "fillColor": get_cc_Color210630(feature.properties.CC210630),// CHANGE COLOR PROPPERTIES
//   "fillOpacity": 0.7
// }}});

var layer_plot_boundary_wtx = new L.GeoJSON.AJAX("gis_layers/2021_cc_driscoll_10m_grid_canopy_cover_cotton.geojson", {onEachFeature:popUp_layer_plot_boundary_wtx, zIndex: 101, style: function (feature){// THIRD
return {
  "color": 'black',
  "weight": 1,
  "opacity": 1,
  "fillColor": get_cc_Color(feature.properties.CC210630),// CHANGE COLOR PROPPERTIES
  "fillOpacity": 0.7
}}});

function popUp_layer_plot_boundary_wtx(f,l) {
var out = [];
if (f.properties) {
out.push("Grid ID: : "+ f.properties["FID"]);
out.push("Canopy Cover: "+ f.properties["CC210630"].toFixed(2) + " %");
