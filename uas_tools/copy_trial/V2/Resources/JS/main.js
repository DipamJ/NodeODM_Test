    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (data.length > 0)
            {
                ...
                var table = "<div class='table-responsive'><table id='imported-set-table' class='table'>" +
...

                {
                    ...
                    //added
                        ...
                        "<button style='padding: 6px !important;' data-id = " + item.ID + " class='delete'><img src='https://chub.gdslab.org/uas_tools/las_upload/Resources/Images/delete.png'></button>" +
                        "</td>" +
...
function SelectDataSet(datasetID){
    ...
    $("#data-set-" + datasetID).children('td,th').css('background-color','rgb(166, 165, 234)');
        ...
        success: function(response) {
...

            {
                ...
                $.each(data,function(index,criteria) {
                    ...
                    var list = "<div class='col-md-4'><div class='form-group'><label>" + name + "</label>" +
...
function ShowValueTable(){
    ...
    var table = "<table id='value' >" +
        ...
        "<th class='bg-dark text-white'><input id='check-all-value' type='checkbox' checked onchange='ToggleAllSelectValues();'></th>";
...
function ShowTable(){
    ...
    var table = "<table id='imported-table'>" +
        ...
        "<th style='background: #555555; color: #ffffff;'><input id='check-all' type='checkbox' checked onchange='ToggleAllRowInPage();'></th>" ;
    ...
    $.each(fields,function(index,field){
        ...
        if (field.indexOf("criteria") != -1){
            ...
            table+= "<th style='background: #555555; color: #ffffff;'>" + field.replace("criteria_","") + "</th>";

            colWidth = 100;

        } else {

            table+= "<th style='background: #555555; color: #ffffff;'>" + field.replace("data_","") + "</th>";
