...
function GenerateNDVIChart() {
    ...
    d3.json("Resources/PHP/GenerateNDVIChart.php", function (error, chartData) {
        ...
        if (max < d3.max(chartData, function (d) {
            return d.value;
        })) {
        ...
        function mousemove() {
            ...
            $('#horizontal-line').attr('x1', -(width - x(d3.max(chartData, function (d) {
                return d.dae;
            }) - d.dae) - 10).toString());
    ...
    d3.json("Resources/PHP/GenerateGrowthRateChart.php", function (error, chartData) {
        ...
        */
        ...
        function mousemove() {
            ...
            $('#gr-horizontal-line').attr('x1', -(width - x(d3.max(chartData, function (d) {
                return d.dae;
            }) - d.dae) - 10).toString());
