...
#PHP code that grabs the path to the zip file and the temporary results directory. The code then calls to a python file (CheckZipStatus.py) which then checks the status of the zip.
    ...
    //$bool = filter_var($_GET["bool"]);
     ...
     $checkZip_command = "python3 /var/www/html/uas_tools/multispectral_attribute_generator/Resources/Python/CheckZipStatus.py $zip_result $ndvi_checked $ndre_checked $msavi_checked $selected_ortho_temp $selected_project";
     //echo $checkZip_command;
