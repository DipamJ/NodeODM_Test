...
// command to call python file that generates the canopy attributes with the selected project, orthomosaic, CHM, boundary files as well as the checked attributes.
     ...
     $generate_dat_files_command = "python3 /var/www/html/uas_tools/multispectral_attribute_generator/Resources/Python/generate_dat_files_new.py $selected_project $selected_orthomosaic $selected_boundary $ndvi_checked $ndre_checked $msavi_checked";
