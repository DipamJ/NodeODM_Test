...
#Value of items consist of a large string with multiple variables delimited my "::". See Get List functions in main JavaScript file
     ...
     $ndvi_checked = $_GET["ndvi_ckd"];
     $ndre_checked = $_GET["ndre_ckd"];
     $msavi_checked = $_GET["msavi_ckd"];
  ...
  //    }
     ...
     $generateZip_command = "python3 /var/www/html/uas_tools/multispectral_attribute_generator/Resources/Python/generateZip.py $selected_project $selected_orthomosaic $selected_boundary $csv_checked $xls_checked $geojson_checked $shape_checked $ndvi_checked $ndre_checked $msavi_checked $val";
     //echo $generateZip_command;
