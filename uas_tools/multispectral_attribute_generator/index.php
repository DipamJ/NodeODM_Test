    ...
    <div class="container py-3">
        <div class="project" >
                    <div style="display: inline-block;">
						<h3>Multispectral Attributes Generator</h3>
					</div>
          ...
          <div class = "arrowpopup" >
            <span>* = Optional Files. Click
              ...
              Select a project along with a platform and sensor. Then, select plot boundary/grids and orthomosaic(s).
              Canopy Height Model(s) selection is optional. They are only necessary to generate canopy height or volume.
              Select the canopy attribute to generate. After clicking the "Generate Results" button,
              select the file formats to download (Shape, GeoJSON, CSV, and XLSX).
              Generated files are available to download through the "Download Generated Files"
              button, which will then download a Zip file of the specified attributes and file formats selected.
              <a href="HowToUseCanopyAttributesGeneratorTool.txt" download="HowToUseCanopyAttributesGeneratorTool.txt">Download user guide here!</a>
                    ...
                    <div class = "row">
						...
						<div class="col-md-12" style="margin-top: 15px;">
                          ...
                          <!-- <div class="col-md-6" style="margin-top: 15px;">
                            <div class="form-group">
                            <label>* Canopy Height Models</label>
                  ...
                  <div class="col-lg-12">
                      <label>Select canopy features to generate:</label>
                            ...
                            <table id="product-table-0" class="table table-bordered">
                              <thead style="">
                                <tr style="color: white; background: #500000;">
                                  <th style="border: none;">
                                    <input id="check-all-caTable" type="checkbox" checked="" onchange="ToggleAllRowData_caTable();">
                                  </th>
                                  <th style="border: none; background: #500000;">Select All</th>
                                </tr>
                              </thead>
                              <tbody id="product-list-0">
                                ...
                                <!-- <tr>
                                  ...
                                  <td style="">
                                    <span>Canopy Volume</span>
                                  </td>
                                </tr> -->

                              <tr>
                                <td style="">
                                  <input id="ndvi_cb" name="ndvi_cb" type="checkbox" value="NDVI" checked="" onchange="ToggleRowData_caTable();">
                                </td>
                                <td style="">
                                  <span>NDVI</span>
                                </td>
                              ...
                              <tr>
                                <td style="">
                                  <input id="ndre_cb" name="ndre_cb" type="checkbox" value="NDRE" checked="" onchange="ToggleRowData_caTable();">
                                </td>
                                <td style="">
                                  <span>NDRE</span>
                                </td>
                              ...
                              <tr>
                                <td style="">
                                  <input id="msavi_cb" name="msavi_cb" type="checkbox" value="MSAVI" checked="" onchange="ToggleRowData_caTable();">
                                </td>
                                <td style="">
                                  <span>MSAVI</span>
                                </td>
