	...
	if (CheckInput(type, null)){
		...
		if (type == 'flight'){
			...
			url = url + "&crop=" + crop + "&plantingDate=" + plantingDate + "&harvestDate=" + harvestDate +
				...
				"&minZoom=" + minZoom + "&maxZoom=" + maxZoom + "&defaultZoom=" + defaultZoom + "&visualization=" + visualization + "&visible=" + visible;
		}
		//////
	...
	$.ajax({
		...
		success: function(response) {
            ...
            "<th style='border: none;'>Crop</th>" +
						...
						"<th style='border: none;'>Visible</th>";
					...
					if (type == "flight"){
						...
						if (type == 'project'){
							items+= "<td style='overflow:hidden'>" +
								...
								"</td>" +
								"<td style='overflow:hidden'>" +
								"<span id='" + type + "-" + item.ID +"-display-visible-page'>" + item.Visible + "</span>" +
								"<input id='" + type + "-" + item.ID +"-edit-visible-page' class='edit-input' type='text' value='" + item.Visible + "' style='display:none'>" +
								"</td>";
						}
...
function Edit(id, type){
	...
	if (type == "flight"){
		...
		$('#' + type + '-' + id + '-edit-visible-page').val($('#' + type + '-' + id + '-display-visible-page').html());
...
function ConfirmEdit(id, type){
	...
	if (CheckInput(type, id)){
		...
		if (type == 'flight'){
			...
			var visiblePage = $('#' + type + '-' + id + '-edit-visible-page').val();

			url = url + "&crop=" + crop + "&plantingDate=" + plantingDate + "&harvestDate=" + harvestDate +
				"&description=" + description + "&centerLat=" + centerLat + "&centerLng=" + centerLng +
				"&minZoom=" + minZoom + "&maxZoom=" + maxZoom + "&defaultZoom=" + defaultZoom + "&visualization=" + visualizationPage + "&visible=" + visiblePage;
			...
			success: function(response) {
				if (response == "1") {
					...
					if (type == "flight"){
						...
						$('#' + type + '-' + id + '-display-visible-page').html($('#' + type + '-' + id + '-edit-visible-page').val());
