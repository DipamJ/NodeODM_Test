...
cc_data = [float(numeric_string) for numeric_string in sys.argv[2].split(',')]
type = sys.argv[3]
parameters = [float(numeric_string) for numeric_string in sys.argv[4].split(',')]
start_date = [int(numeric_string) for numeric_string in sys.argv[5].split('/')]
lday = int(sys.argv[6])
