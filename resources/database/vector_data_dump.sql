...
--
-- Table structure for table `vector_data`
--
...
CREATE TABLE `vector_data` (
  ...
  `EPSG` int(11) NOT NULL DEFAULT 4326,
  ...
  `TMSPath` varchar(2000) DEFAULT NULL,
  ...
  KEY `Type` (`Type`),
  CONSTRAINT `product_type_relation2` FOREIGN KEY (`Type`) REFERENCES `product_type` (`ID`)
...
-- Dump completed on 2021-06-28 20:15:18
