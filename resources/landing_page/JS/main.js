var markers = L.markerClusterGroup({
	...
	iconCreateFunction: function(cluster) {
		...
		$.each(children,function(index,child){
			if (child.options.icon.options.iconUrl == "resources/landing_page/Images/camera-drone-1.png"){
			//if (child.options.icon.options.iconUrl == "Resources/Images/drone.png"){
				projectCount++;
			} else {
				pointcloudCount++;
			}
...
var projectIcon = L.icon({
    iconUrl: "resources/landing_page/Images/camera-drone-1.png"
    //iconUrl: "Resources/Images/drone_small.png"
});
...
var pointcloudIcon = L.icon({
    iconUrl: "resources/landing_page/Images/cloud.png"
});
...
function GetProjectList(){
	$.ajax({
		url: "resources/landing_page/PHP/Project.php",
		dataType: 'text',
		data: { action: 'list'},
...
function GetPointcloudList(){
	$.ajax({
		url: "resources/landing_page/PHP/Pointcloud.php",
		dataType: 'text',
		data: { action: 'list'},
		success: function(response) {
			var data = JSON.parse(response);
