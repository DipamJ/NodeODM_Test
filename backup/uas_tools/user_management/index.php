...
//}
            ...
            if (isset($_GET['logout']) && $_GET['logout'] == true) { // When user clicks on logout button
                session_start();
                session_destroy();
            ...
            <div class="container">
                <div class="card card-login mx-auto mt-5">
                    ...
                    <div class="card-body">
                        ...
                        <a href=<?php echo $header_location . "/uas_tools/user_management/AddUser.php" ?>>Click here to
                            add new user</a>
