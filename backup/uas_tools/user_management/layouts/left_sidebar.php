            ...
            <li class="nav-item dropdown" title="Essential Tools">
                ...
                <i class="fa fa-wrench fa-fw"></i>
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                     ...
                     <a class="dropdown-item" href=<?= $header_location . "/uas_tools/upload_raw" ?> target="iframe_a">Upload Raw Data</a>
            ...
            <li class="nav-item dropdown" title="Additional Tools">
              ...
              <i class="fa fa-gavel fa-fw"></i>
                  <span class="nav-link-text">Additional Tools</span>
                   ...
                   <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href=<?= $header_location . "/uas_tools/upload_geojson" ?> target="iframe_a">Upload Vector Data</a>
                    <a class="dropdown-item" href=<?= $header_location . "/uas_tools/las_upload/" ?> target="iframe_a">Upload LAS</a>
                    <a class="dropdown-item" href=<?= $header_location . "/uas_tools/import_crop_data/" ?> target="iframe_a">Import Crop Data</a>
                    <a class="dropdown-item" href=<?= $header_location . "/uas_tools/crop_analysis/" ?> target="iframe_a">Crop Analysis</a>
                    <a class="dropdown-item" href=<?= $header_location . "/uas_tools/plot_boundary/" ?> target="iframe_a">Plot Boundary</a>
                    <a class="dropdown-item" href=<?= $header_location . "/uas_tools/plot_grid/" ?> target="iframe_a">Plot Grid</a>
                  </div>
            </li>
