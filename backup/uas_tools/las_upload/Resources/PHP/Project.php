...
function AddProject($projectName, $crop, $plantingDate, $harvestDate, $description, $centerLat,
                    $centerLng, $minZoom, $maxZoom, $defaultZoom, $con)
{
...
function UpdateProject($projectID, $projectName, $crop, $plantingDate, $harvestDate, $description, $centerLat,
                       $centerLng, $minZoom, $maxZoom, $defaultZoom, $con)
{
        ...
        case "add":
            {
                ...
                //AddProject($name, $con);
                AddProject($name, $crop, $plantingDate, $harvestDate, $description, $centerLat,
                    $centerLng, $minZoom, $maxZoom, $defaultZoom, $con);
            }
            break;
        case "list":
        ...
        case "edit":
            {
                ...
                UpdateProject($id, $name, $crop, $plantingDate, $harvestDate, $description, $centerLat,
                    $centerLng, $minZoom, $maxZoom, $defaultZoom, $con);
            }
            break;
        case "delete":
