var markers = L.markerClusterGroup({
	...
	iconCreateFunction: function(cluster) {
		...
		$.each(children,function(index,child){
			if (child.options.icon.options.iconUrl == "Resources/Images/camera-drone-1.png"){
...
var projectIcon = L.icon({
    iconUrl: "Resources/Images/camera-drone-1.png"
...
var pointcloudIcon = L.icon({
    iconUrl: "Resources/Images/cloud.png"
});
