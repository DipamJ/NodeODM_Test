...
function Convert($identifier, $con)
{
    ...
    $command = "$converterPath --processes=" . $cpu_number . " -z  " . $minZoom . "-" . $maxZoom . " -s EPSG:" . $epsg . " '$sourcePath' '$destPath' >> " . $file["UploadFolder"] . "/convert_log.txt";
...
//        $TMSPath = str_replace("/var/www/html/", "https://basfhub.gdslab.org/", $destPath) . "/{z}/{x}/{y}.png";
        ...
        //$displayPath = str_replace("/var/www/html/", "http://bhub.gdslab.org/", $destPath) . "/leaflet.html";
        $displayPath = str_replace("/var/www/html/", $header_location . "/", $destPath) . "/leaflet.html";
        //$TMSPath = str_replace("/var/www/html/wordpress/", "http://bhub.gdslab.org/", $destPath) . "/{z}/{x}/{y}.png";
        //$TMSPath = str_replace("/var/www/html/", "http://bhub.gdslab.org/", $destPath) . "/{z}/{x}/{y}.png";
        $TMSPath = str_replace("/var/www/html/", $header_location . "/", $destPath) . "/{z}/{x}/{y}.png";
...
//      $displayThumbPath = str_replace("/var/www/html/", "https://uashub.tamucc.edu/", $destPath) . "/" . FormatFileName($fileNameParts["filename"]) . "_thumb.jpg";
        ...
        //$displayThumbPath = str_replace("/var/www/html/", "http://bhub.gdslab.org/", $destPath) . "/" . FormatFileName($fileNameParts["filename"]) . "_thumb.jpg";
        $displayThumbPath = str_replace("/var/www/html/", $header_location . "/", $destPath) . "/" . FormatFileName($fileNameParts["filename"]) . "_thumb.jpg";
        //////
