...
$(document).ready(function(){
	...
	window.onbeforeunload = function() {
		if (uploading){
			...
			$('#warning').show();
			$('#warning-text').text('Please click on "Done" before closing the page.');
			$('#done').focus();
			return 'Please wait.';
		}
	}
...
function CompressFiles(){
	...
	$.ajax({
		url: 'Resources/PHP/CompressFiles.php',
		dataType: 'text',
		data: { project: project, platform: platform, sensor: sensor, date: date, flight: flight, type: type},     
		success: function(response) {
		}
	});
}
...
function InitFiler(){
	...
	$("#filer_input").filer({
		...
		extensions: null,
		changeInput: '<div class="jFiler-input-dragDrop"><div class="jFiler-input-inner"><div class="jFiler-input-icon"><i class="icon-jfi-cloud-up-o"></i></div><div class="jFiler-input-text"><h3>Drag&Drop file here</h3> <span style="display:inline-block; margin: 15px 0">or</span></div><a class="jFiler-input-choose-btn blue">Browse</a></div></div>',
		showThumbs: true,
		theme: "dragdropbox",
		templates: {
		...
		uploadFile: {
			url: "Resources/jQuery.filer/php/UploadRaw.php",
			data: 	{
						projectID: projectID, 
