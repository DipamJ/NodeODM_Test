...
{
    $sql = "insert into project (Name, Crop, PlantingDate, HarvestDate, Description, CenterLat, CenterLng, MinZoom, MaxZoom, DefaultZoom, VisualizationPage) " .
        " values ('$projectName', $crop, '$plantingDate', '$harvestDate', '$description', $centerLat, $centerLng, $minZoom, $maxZoom, $defaultZoom, '$visualization')";
...
)
{
    $sql = "update project set Name='$projectName', Crop=$crop, PlantingDate='$plantingDate', HarvestDate='$harvestDate', " .
        "Description='$description', CenterLat=$centerLat, CenterLng=$centerLng, MinZoom=$minZoom, MaxZoom=$maxZoom, DefaultZoom=$defaultZoom, VisualizationPage='$visualization' " .
        "where id=$projectID";
    //echo $sql;
    $result = mysqli_query($con, $sql);
