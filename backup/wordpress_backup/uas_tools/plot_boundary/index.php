        ...
        <div id="tabs">
            ...
            <div id="gen-boundary">
                <fieldset id="gen-plot-boundary-properties" style="width: 90%">
                    ...
                    <div class="input"><input type="button" value="Set" onclick="SetVarNumber(''); return false;"
                                              class='button' style='width: 50px; margin:0'/></div>
                    ...
                    <div class='apply-all'>
                        ...
                        <div class="input"><input type="button" value="Apply"
                                                  onclick="ApplyAll('offset',''); return false;" class='button'
                                                  style='width: 50px; margin:0'/></div>
                    </div>
                    <div style="clear:both"></div>
                    <div class="full-width" id='offsets'
                         style="height: 90px; overflow-y: overlay; border: 1px solid gray;padding: 2px; margin: 10px 0"></div>
                    ...
                    <div class='apply-all'>
                        ...
                        <div class="input"><input type="button" value="Apply"
                                                  onclick="ApplyAll('vshift',''); return false;" class='button'
                                                  style='width: 50px; margin:0'/></div>
                    </div>
                    <div style="clear:both"></div>
                    ...
                    <input id="generate-boundary" type="button" value="Generate"
                           onclick="GeneratePlotBoundary(); return false;" class='button'/>
            ...
            <div id="mod-boundary">
                ...
                <fieldset id="mod-plot-boundary-properties" style="width: 90%; display:none">
                    ...
                    <div class="input"><input type="button" value="Set" onclick="SetVarNumber('mod'); return false;"
                                              class='button' style='width: 50px; margin:0'/></div>
                    ...
                    <div>
                        ...
                        <div class="input"><input type="button" value="Apply"
                                                  onclick="ApplyAll('offset','mod'); return false;" class='button'
                                                  style='width: 50px; margin:0'/></div>
                    </div>
                    <div style="clear:both"></div>
                    <div class="full-width" id='mod-offsets'
                         style="height: 90px; overflow-y: overlay; border: 1px solid gray;padding: 2px; margin: 10px 0"></div>
                    ...
                    <div>
                        ...
                        <div class="input"><input type="button" value="Apply"
                                                  onclick="ApplyAll('vshift','mod'); return false;" class='button'
                                                  style='width: 50px; margin:0'/></div>
                    </div>
                    <div style="clear:both"></div>
                    <div class="full-width" id='mod-vshifts'
                         style="height: 90px; overflow-y: overlay; border: 1px solid gray;padding: 2px; margin: 10px 0"></div>
            ...
            <div id="info">
                <fieldset style="width: 90%;">
                    ...
                    <input type="button" value="Import" onclick="$('#imported-info-map').click(); return false;"
                ...
                <fieldset style="width: 90%;">
                    ...
                    <input type="button" value="Import" onclick="$('#imported-info-code').click(); return false;"
                           class="button" style="float:left; margin: 2px"/>
                    <div style="clear:both"></div>
                    <div id="info-code-header" class="info-header"></div>
                    <div id="info-code-wrapper" class="info-wrapper"></div>
                </fieldset>
                <input type="button" value="Apply" onclick="ApplyInfo(); return false;" class="button"
...
<div id="dialog-confirm" title="Ignore the mismatch?" style="display:none;">
    <p><span class="ui-icon ui-icon-alert" style="float:left; margin:12px 12px 20px 0;"></span>One or more entries are
        not found in the info code list. Ignore?</p>
</div>
