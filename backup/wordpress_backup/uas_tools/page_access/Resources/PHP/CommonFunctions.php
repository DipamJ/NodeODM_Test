...
//
//                //$downloadPath = str_replace("/var/www/html/", "http://uashub.tamucc.edu/", $destinationFolder . "/" . $newFileFullName);
//                //$displayPath = str_replace("/var/www/html/", "http://uashub.tamucc.edu/", $destinationFolder . "/Thumbnails/" . $newFileName . "_thumb.jpg");
//
//                $downloadPath = str_replace($root_path, $header_location, $destinationFolder . "/" . $newFileFullName);
//                $displayPath = str_replace($root_path, $header_location, $destinationFolder . "/Thumbnails/" . $newFileName . "_thumb.jpg");
//
